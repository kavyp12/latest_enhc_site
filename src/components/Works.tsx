...
export default function Works() {
    ...
    return (
        <section id="works" className="relative min-h-screen bg-black py-20 overflow-hidden">
            ...
            <div className="container mx-auto px-6 relative z-10" style={{ maxWidth: '1500px' }}>
                <div className="text-left mb-12">
                    <h2 className="text-2xl text-white z-50 container pb-5">
                        Our Works
                    </h2>
                        ...
                        >
                            ...
                            `}>
                                ...
                                `}>
                                    ...
                                    {/* Title & Subtitle */}
                                    <div>
                                        <h3 className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-white to-gray-100 bg-clip-text text-transparent group-hover:from-purple-400 group-hover:to-orange-400 transition-all duration-500 mb-3">
                                            {item.title}
                                        </h3>
                                            ...
                                            {item.technologies.map((tech, techIndex) => (
                                                <div
                                                    ...
                                                    className={`
                                                        ...
                                                        ${hoveredTech === tech
                                                            ? 'bg-gradient-to-r from-purple-500 to-orange-500 text-white border-transparent transform scale-110 shadow-lg shadow-purple-500/25'
                                ...
                                `}>
                                    <div className="relative">
                                        ...
                                        `}></div>
                                        <div className="absolute -top-4 -right-4 w-20 h-20 bg-gradient-to-br from-purple-400 to-orange-400 rounded-full blur-2xl opacity-60 group-hover/image:opacity-100 transition-opacity duration-500"></div>
                                        <div className="absolute -bottom-4 -left-4 w-16 h-16 bg-gradient-to-br from-orange-400 to-yellow-400 rounded-full blur-2xl opacity-60 group-hover/image:opacity-100 transition-opacity duration-500"></div>
