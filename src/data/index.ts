export const gridItems = [
    ...
    },
    {
        ...
        subtitle: "Revenue-Driving Online Stores",
        ...
        longDescription: "We build comprehensive e-commerce solutions with advanced inventory management, secure payment processing, and conversion-optimized checkout flows. Our platforms are designed to handle high traffic and grow with your business.",
    ...
    },
    {
        ...
        longDescription: "We leverage cutting-edge technologies and best practices to build websites that are fast, secure, and scalable. Our development process includes thorough testing, optimization, and deployment strategies for maximum performance.",
        className: "lg:col-span-2 md:col-span-3 md:row-span-2",
        imgClassName: "",
        titleClassName: "justify-start",
        descriptionClassName: "max-w-[50vw] md:max-w-sm",
        ...
        icon: "⚡",
        features: ["Modern Frameworks", "API Integration", "Database Design", "Cloud Hosting"],
    ...
    },
    {
        ...
        longDescription: "We develop cohesive brand identities that resonate with your target audience and differentiate you from competitors. Our process includes brand strategy, visual identity design, and brand guidelines to ensure consistency across all touchpoints.",
    ...
    },
    {
        ...
        longDescription: "Our data-driven marketing approach combines technical SEO, content strategy, and performance marketing to increase your online presence and drive qualified traffic that converts into customers.",
        className: "lg:col-span-2 md:col-span-3 md:row-span-2",
        imgClassName: "",
        titleClassName: "justify-center",
        descriptionClassName: "max-w-[50vw] md:max-w-sm",
        ...
        icon: "📈",
        features: ["Keyword Research", "Content Strategy", "Link Building", "Analytics Tracking"],
